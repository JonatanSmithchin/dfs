...
struct DirectoryListingDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DirectoryListingDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DirectoryListingDefaultTypeInternal _DirectoryListing_default_instance_;
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        { 70, -1, -1, sizeof(::DirectoryListing)},
        { 80, -1, -1, sizeof(::Block)},
...
inline void DirectoryListing::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
