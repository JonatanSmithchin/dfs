...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dfs_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_dfs_2eproto_2epb_2eh
...
template <>
::BlockKey* Arena::CreateMaybeMessage<::BlockKey>(Arena*);
template <>
::BlockWithLocation* Arena::CreateMaybeMessage<::BlockWithLocation>(Arena*);
template <>
::BlocksWithLocation* Arena::CreateMaybeMessage<::BlocksWithLocation>(Arena*);
template <>
::DatanodeID* Arena::CreateMaybeMessage<::DatanodeID>(Arena*);
template <>
::DatanodeInfo* Arena::CreateMaybeMessage<::DatanodeInfo>(Arena*);
template <>
::DirestoryListing* Arena::CreateMaybeMessage<::DirestoryListing>(Arena*);
template <>
::FileStatus* Arena::CreateMaybeMessage<::FileStatus>(Arena*);
template <>
::LocatedBlock* Arena::CreateMaybeMessage<::LocatedBlock>(Arena*);
template <>
::LocatedBlocks* Arena::CreateMaybeMessage<::LocatedBlocks>(Arena*);
template <>
::Permission* Arena::CreateMaybeMessage<::Permission>(Arena*);
template <>
::ServerDefaults* Arena::CreateMaybeMessage<::ServerDefaults>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
enum DatanodeInfo_AdminState : int {
  ...
  DatanodeInfo_AdminState_DatanodeInfo_AdminState_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  DatanodeInfo_AdminState_DatanodeInfo_AdminState_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool DatanodeInfo_AdminState_IsValid(int value);
constexpr DatanodeInfo_AdminState DatanodeInfo_AdminState_AdminState_MIN = static_cast<DatanodeInfo_AdminState>(0);
constexpr DatanodeInfo_AdminState DatanodeInfo_AdminState_AdminState_MAX = static_cast<DatanodeInfo_AdminState>(2);
constexpr int DatanodeInfo_AdminState_AdminState_ARRAYSIZE = 2 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
DatanodeInfo_AdminState_descriptor();
template <typename T>
const std::string& DatanodeInfo_AdminState_Name(T value) {
  static_assert(std::is_same<T, DatanodeInfo_AdminState>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to AdminState_Name().");
  return DatanodeInfo_AdminState_Name(static_cast<DatanodeInfo_AdminState>(value));
}
template <>
inline const std::string& DatanodeInfo_AdminState_Name(DatanodeInfo_AdminState value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<DatanodeInfo_AdminState_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool DatanodeInfo_AdminState_Parse(absl::string_view name, DatanodeInfo_AdminState* value) {
...
enum FileStatus_FileType : int {
  ...
  FileStatus_FileType_FileStatus_FileType_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  FileStatus_FileType_FileStatus_FileType_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool FileStatus_FileType_IsValid(int value);
constexpr FileStatus_FileType FileStatus_FileType_FileType_MIN = static_cast<FileStatus_FileType>(0);
constexpr FileStatus_FileType FileStatus_FileType_FileType_MAX = static_cast<FileStatus_FileType>(2);
constexpr int FileStatus_FileType_FileType_ARRAYSIZE = 2 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
FileStatus_FileType_descriptor();
template <typename T>
const std::string& FileStatus_FileType_Name(T value) {
  static_assert(std::is_same<T, FileStatus_FileType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to FileType_Name().");
  return FileStatus_FileType_Name(static_cast<FileStatus_FileType>(value));
}
template <>
inline const std::string& FileStatus_FileType_Name(FileStatus_FileType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<FileStatus_FileType_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool FileStatus_FileType_Parse(absl::string_view name, FileStatus_FileType* value) {
...
enum ChecksumType : int {
  ...
  CHECKSUM_NULL = 1,
  CHECKSUM_CRC32C = 2,
  ChecksumType_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  ChecksumType_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool ChecksumType_IsValid(int value);
constexpr ChecksumType ChecksumType_MIN = static_cast<ChecksumType>(0);
constexpr ChecksumType ChecksumType_MAX = static_cast<ChecksumType>(2);
constexpr int ChecksumType_ARRAYSIZE = 2 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
ChecksumType_descriptor();
template <typename T>
const std::string& ChecksumType_Name(T value) {
  static_assert(std::is_same<T, ChecksumType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to ChecksumType_Name().");
  return ChecksumType_Name(static_cast<ChecksumType>(value));
}
template <>
inline const std::string& ChecksumType_Name(ChecksumType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ChecksumType_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool ChecksumType_Parse(absl::string_view name, ChecksumType* value) {
...
class DatanodeID final :
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_datanodeuuid(Arg_&& arg, Args_... args);
  std::string* mutable_datanodeuuid();
  PROTOBUF_NODISCARD std::string* release_datanodeuuid();
  void set_allocated_datanodeuuid(std::string* ptr);

  private:
  const std::string& _internal_datanodeuuid() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_datanodeuuid(
      const std::string& value);
...
class DatanodeInfo final :
 ...
 public:
  ...
  using AdminState = DatanodeInfo_AdminState;
  static constexpr AdminState NORMAL = DatanodeInfo_AdminState_NORMAL;
  static constexpr AdminState DECOMMISSION_INPROGRESS = DatanodeInfo_AdminState_DECOMMISSION_INPROGRESS;
  static constexpr AdminState DECOMMISSIONED = DatanodeInfo_AdminState_DECOMMISSIONED;
  static inline bool AdminState_IsValid(int value) {
    return DatanodeInfo_AdminState_IsValid(value);
  }
  static constexpr AdminState AdminState_MIN = DatanodeInfo_AdminState_AdminState_MIN;
  static constexpr AdminState AdminState_MAX = DatanodeInfo_AdminState_AdminState_MAX;
  static constexpr int AdminState_ARRAYSIZE = DatanodeInfo_AdminState_AdminState_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* AdminState_descriptor() {
    return DatanodeInfo_AdminState_descriptor();
  }
  template <typename T>
  static inline const std::string& AdminState_Name(T value) {
    return DatanodeInfo_AdminState_Name(value);
  }
  static inline bool AdminState_Parse(absl::string_view name, AdminState* value) {
...
class FileStatus final :
 ...
 public:
  ...
  using FileType = FileStatus_FileType;
  static constexpr FileType IS_DIR = FileStatus_FileType_IS_DIR;
  static constexpr FileType IS_FILE = FileStatus_FileType_IS_FILE;
  static constexpr FileType IS_SYMLINK = FileStatus_FileType_IS_SYMLINK;
  static inline bool FileType_IsValid(int value) {
    return FileStatus_FileType_IsValid(value);
  }
  static constexpr FileType FileType_MIN = FileStatus_FileType_FileType_MIN;
  static constexpr FileType FileType_MAX = FileStatus_FileType_FileType_MAX;
  static constexpr int FileType_ARRAYSIZE = FileStatus_FileType_FileType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* FileType_descriptor() {
    return FileStatus_FileType_descriptor();
  }
  template <typename T>
  static inline const std::string& FileType_Name(T value) {
    return FileStatus_FileType_Name(value);
  }
...
class BlockWithLocation final :
 ...
 public:
  ...
  void set_datanodeuuids(int index, const char* value, std::size_t size);
  void set_datanodeuuids(int index, absl::string_view value);
  ...
  void add_datanodeuuids(const char* value, std::size_t size);
  void add_datanodeuuids(absl::string_view value);
...
class BlockKey final :
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_keybytes(Arg_&& arg, Args_... args);
  std::string* mutable_keybytes();
  PROTOBUF_NODISCARD std::string* release_keybytes();
  void set_allocated_keybytes(std::string* ptr);

  private:
  const std::string& _internal_keybytes() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_keybytes(
      const std::string& value);
...
inline PROTOBUF_ALWAYS_INLINE void DatanodeID::set_ipaddr(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void DatanodeID::set_allocated_ipaddr(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void DatanodeID::set_hostname(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void DatanodeID::set_allocated_hostname(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void DatanodeID::set_datanodeuuid(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.datanodeuuid_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void DatanodeID::set_allocated_datanodeuuid(std::string* value) {
  _impl_.datanodeuuid_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void DatanodeInfo::set_location(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void DatanodeInfo::set_allocated_location(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void FileStatus::set_path(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void FileStatus::set_allocated_path(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void FileStatus::set_owner(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void FileStatus::set_allocated_owner(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void FileStatus::set_group(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void FileStatus::set_allocated_group(std::string* value) {
...
inline void BlockWithLocation::set_datanodeuuids(int index, const char* value,
                              std::size_t size) {
  _impl_.datanodeuuids_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:BlockWithLocation.datanodeUuids)
}
inline void BlockWithLocation::set_datanodeuuids(int index, absl::string_view value) {
  _impl_.datanodeuuids_.Mutable(index)->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_set_string_piece:BlockWithLocation.datanodeUuids)
}
inline std::string* BlockWithLocation::_internal_add_datanodeuuids() { return _impl_.datanodeuuids_.Add(); }
...
inline void BlockWithLocation::add_datanodeuuids(const char* value, std::size_t size) {
...
inline void BlockWithLocation::add_datanodeuuids(absl::string_view value) {
  _impl_.datanodeuuids_.Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:BlockWithLocation.datanodeUuids)
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* BlockWithLocation::mutable_datanodeuuids() {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void BlockKey::set_keybytes(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.keybytes_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void BlockKey::set_allocated_keybytes(std::string* value) {
  _impl_.keybytes_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <>
struct is_proto_enum<::DatanodeInfo_AdminState> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::DatanodeInfo_AdminState>() {
  return ::DatanodeInfo_AdminState_descriptor();
}
template <>
struct is_proto_enum<::FileStatus_FileType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::FileStatus_FileType>() {
  return ::FileStatus_FileType_descriptor();
}
template <>
struct is_proto_enum<::ChecksumType> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_dfs_2eproto_2epb_2eh
